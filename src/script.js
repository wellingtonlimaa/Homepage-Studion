$(document).ready(() => {
    ...
    const slickOptions = {
      ...
      // pauseOnHover: false,
      prevArrow:
        '<button type="button" class="slick-prev slider__prev slick-arrow">Previous</button>;',
      nextArrow:
        '<button type="button" class="slick-next slider__next slick-arrow">Previous</button>;',
    };
